...
from ..shared.interface_config import InterfaceTheme, InterfaceSettings
from ..shared.compat import DlgBtnOk, DlgBtnCancel, DlgBtnRestoreDefaults
...
class PreferencesDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        buttons = QDialogButtonBox(
            DlgBtnOk | DlgBtnCancel | DlgBtnRestoreDefaults
        )
        buttons.accepted.connect(self.accept)
        buttons.rejected.connect(self.reject)
        buttons.button(DlgBtnRestoreDefaults).clicked.connect(self.restore_defaults)
